				...
				<div class="col-md-12">
					...
					<div class="main-search-input">
						...
						<div class="main-search-input-item">
							<input type="text" placeholder="Ямар газар хайж байна?" value=""/>
						</div>

						<div class="main-search-input-item">
							<select data-placeholder="Төрлөөр хайх" class="chosen-select" >
						...
						<button class="button">Хайх</button>
			...
			<div class="row margin-bottom-25 margin-top-40">
				...
				<div class="col-md-6">
					...
					<div class="layout-switcher">
						...
						<a href="{{route('fullwidth')}}" class="list"><i class="fa fa-align-justify"></i></a>
					</div>
				</div>
