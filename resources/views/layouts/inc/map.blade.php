...
(function($) {
  ...
  function mainMap() {
    ...
    var locations = [
      ...
      [locationData('{{route('listings')}}', 'images/listing-item-01.jpg', "{{$service->title}}", '{{$service->address}}', '3.5', '12'), {{$service->latitude}}, {{$service->longitude}}, 1, '<i class="im im-icon-Location-2"></i>'],
      @endforeach
    ];
